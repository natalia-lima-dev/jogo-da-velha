...
function updateTitle () { // updateTitle: serve para mostrar o jogador da vez
    const playerInput = document.getElementById(turnPlayer)
    document.getElementById('turnPlayer').innerText = playerInput.value
}

function initializeGame () { //initializeGame: preparação para o jogo começar
    // Inicializa as variáveis globais 
     vBoard = [['', '', ''], ['', '', ''], ['', '', '']] //mostrar no console através de tabela os dados do jogo.
     turnPlayer = 'player1'
